...
- Email auth, плюс Google/Apple OAuth entry points и callback route
- Onboarding из 5 экранов с синхронизацией `users.is_onboarded`
- Memory Map, Discovery, Live Map, Echoes
- Профиль, edit profile, settings, sign out, смена email/password
- Follow/unfollow, followers/following lists, chapters, create-pin flow
- Реакции и share-action на pin detail, server-backed Echoes debounce через `echo_logs`
...
| `pnpm test` | Workspace wrapper для package-local tests |
